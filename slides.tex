...
Python as a code block is like this:\\
\begin{minted}[style=default, breaklines]{python}
import multiprocessing
...
\begin{minted}[style=github-dark, bgcolor=blueBunreachtNahEireann000002073, breaklines]{python}
import multiprocessing
...
\begin{minted}[style=default, breaklines, fontsize=\tiny]{python}
import sys
import time
...
\begin{minted}[style=default, breaklines]{cpp}
#include <iostream>
#include <thread>
...
\frametitle{Code: C++ (syntax highlighting by minted)}
\color{white255255255}
\begin{minted}[style=github-dark, bgcolor=blueBunreachtNahEireann000002073, breaklines]{cpp}
#include <iostream>
#include <thread>
...
\begin{minted}[style=default, breaklines]{latex}
\documentclass{article}
\title{Processes involving charged mesons}
\author{C.~M.~G.~Lattes, H.~Muirhead, G.~P.~S.~Occhialini, C.~F.~Powell}
\begin{document}
...
{
\color{white255255255}
\begin{minted}[style=github-dark, bgcolor=blueBunreachtNahEireann000002073, breaklines]{latex}
\documentclass{article}
\title{Processes involving charged mesons}
\author{C.~M.~G.~Lattes, H.~Muirhead, G.~P.~S.~Occhialini, C.~F.~Powell}
\begin{document}
